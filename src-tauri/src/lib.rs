...
pub fn run() {
  let app = tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      inferno_service::files::inferno_hash_file,
      inferno_service::files::inferno_verify_binary,
      inferno_service::files::inferno_vendor_path,
      inferno_service::files::inferno_download_binary,
      ...
      inferno_service::directory::inferno_known_folders,
