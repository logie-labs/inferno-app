  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Popup
        ...
        data-size={size}
        className={cn(
          "group/alert-dialog-content fixed top-[calc(50%+var(--inferno-toolbar-height)/2)] left-1/2 z-50 grid max-h-[calc(100dvh-var(--inferno-toolbar-height)-2rem)] w-full -translate-x-1/2 -translate-y-1/2 gap-6 rounded-none bg-popover p-6 text-popover-foreground shadow-md ring-1 ring-foreground/10 outline-none data-[size=default]:max-w-xs data-[size=sm]:max-w-xs data-[size=default]:sm:max-w-md",
